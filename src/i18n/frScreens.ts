...
export const frScreens: Record<keyof typeof enScreens, string> = {
  ...
  'dashboard.lowStockTitle': 'Stock faible',
  'dashboard.lowStockCount': '{{count}} produits sous le seuil de réapprovisionnement',
  'dashboard.lowStockNone': 'Tous les produits sont au-dessus de leur seuil de réapprovisionnement.',
  'dashboard.lowStockLink': 'Voir tous les produits →',
  'dashboard.lowStockUnitsLeft': '{{stock}} restants',
